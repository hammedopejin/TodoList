...
/**
    ...
    public class TodoItemDatabase extends SQLiteOpenHelper {
        ...
        // Adding new item
        void addItem(String task, String day, String month, String year, String note, String pri, String stat) {
        ...
        void updateItem(String task, String day, String month, String year, String note, String pri, String stat, int flag) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        // Getting single item
        ArrayList<String> getAll(String iValue) {
            SQLiteDatabase db = this.getReadableDatabase();
